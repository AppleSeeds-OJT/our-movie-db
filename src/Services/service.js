...
function query() { // this fetches first 20 most popuplar movies from TMDB.
    ...
    return httpService.get(`${BASE_URL_TMDB}popular?api_key=${API_KEY_TMDB}&language=en-US&page=1`);
}
